          ...
          <div className="flex items-center justify-between h-12">
            ...
            <div className="flex items-center space-x-4">
              ...
              <Badge 
                ...
                className={isEditMode ? "bg-brand-teal text-white" : ""}
              >
            ...
            <div className="flex items-center space-x-2">
              ...
              {isEditMode && hasUnsavedChanges && (
                <Button
                  ...
                  onClick={handleSave}
                  disabled={isSaving}
                  className="text-white hover:bg-green-600/20 h-8 bg-green-600/10"
                >
              ...
              <Button
                ...
                className="text-white hover:bg-red-600/20 h-8"
              >
